...
export default function IntegrationsPage() {
  return (
    <div className="space-y-5 max-w-3xl">
          ...
          <div key={i.id} className="card flex items-center gap-5">
            ...
            <div className="flex-1">
              ...
              <div className="flex gap-1.5 flex-wrap">
                {i.syncs.map((s) => (
                  <span key={s} className="text-[10px] bg-[#1E3A1E] dark:bg-[#243347] text-slate-400 px-2 py-0.5 rounded-md">
                    {s}
                  </span>
                ))}
              </div>
      ...
      {/* Manual entry note */}
      <div className="card border-white/[0.04] bg-[#1E3A1E]/50 dark:bg-[#1e2a3a]/50">
