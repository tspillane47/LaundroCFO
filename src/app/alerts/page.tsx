...
export default function AlertsPage() {
  ...
  return (
    <div className="space-y-5 max-w-3xl w-full">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[12px] text-[var(--text-secondary)] mt-1 leading-relaxed">{alert.body}</div>
      ...
      {resolved.length > 0 && (
        <div className="mt-6">
          <h2 className="text-[13px] font-semibold text-[var(--text-muted)] mb-3">Healthy / Resolved</h2>
          <div className="space-y-3">
            {resolved.map((alert) => (
              <div key={alert.id} className="card opacity-60 flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 bg-[var(--bg-card2)]">
                  <AlertSeverityIcon severity={alert.severity} />
                </div>
                <div className="flex-1">
                  ...
                  <div className="text-[13px] font-semibold text-[var(--text-secondary)]">{alert.title}</div>
                  <div className="text-[12px] text-[var(--text-muted)] mt-1">{alert.body}</div>
                </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {[
            ...
            <div key={label} className="card2">
              ...
              <div className="text-[14px] font-semibold text-slate-900">{val}</div>
            </div>
          ))}
        </div>
      </div>
