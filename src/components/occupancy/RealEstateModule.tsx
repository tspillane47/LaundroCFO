  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-[var(--text-muted)] text-[13px]">Loading real estate data...</div>
      </div>
    );
  }
    ...
    <div className="space-y-5">
      ...
      {mode === "view" && !record ? (
        <div className="card text-center py-12">
          <div className="text-[var(--text-secondary)] text-[14px]">No real estate profile on file</div>
