  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-[var(--text-muted)] text-[13px]">Loading lease data...</div>
      </div>
    );
  }
    ...
    <div className="space-y-5">
      ...
      {mode === "view" && !lease && hideHeader ? null : mode === "view" && !lease && !hideHeader ? (
        <div className="card text-center py-12">
          <div className="text-[var(--text-secondary)] text-[14px]">No lease on file</div>
        ...
        <>
          ...
          <div className="card">
            ...
            {options.length === 0 ? (
              <p className="text-[var(--text-muted)] text-[13px]">No renewal options on file.</p>
            ) : (
                ...
                <table className="w-full text-[12px]">
                  ...
                  <tbody className="divide-y divide-white/[0.04]">
                    {options.map((opt) => {
                      ...
                      return (
                        <tr key={opt.id}>
                          <td className="py-2.5 text-[var(--text-secondary)]">{opt.option_number ?? "—"}</td>
                          <td className="py-2.5 text-[var(--text-secondary)]">{opt.option_years ?? "—"}</td>
                          <td className="py-2.5">
                          ...
                          <td className="py-2.5 text-[var(--text-secondary)]">{deadline}</td>
                        </tr>
                      );
                    })}
                  </tbody>
        ...
        <div className="space-y-5">
          <div className="card space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-[11px] text-[var(--text-muted)] mt-1">Edit address in Store Settings</p>
            </div>
